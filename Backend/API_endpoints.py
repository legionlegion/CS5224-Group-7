...
app = Flask(__name__)
CORS(app, origins=["http://localhost:3000", "https://recycling-frontend-dev-306363185631.us-west2.run.app", "https://recycling-frontend-dev-306363185631.asia-southeast1.run.app"])
